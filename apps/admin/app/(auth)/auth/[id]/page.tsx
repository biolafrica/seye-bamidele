...
export default function NewsletterAnalyticsPage({ id }: NewsletterAnalyticsPageProps) {
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-900">{data.newsletter.subject}</p>
            </div>
            <div>
              <h4 className="text-sm font-medium text-gray-600 mb-2">Content</h4>
              <div 
                className="text-gray-700 prose prose-sm max-w-none"
                dangerouslySetInnerHTML={{ __html: data.newsletter.content }}
              />
            </div>
          </div>
        </div>
